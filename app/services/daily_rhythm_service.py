...
def generate_daily_science_rhythm(
    ...
    blocks = [
        ...
        },
        {
            ...
            "end_time": "12:45",
            "duration_minutes": 60,
            "title": "Block 3: Vorlesungs-Podcasts (Nur A-Konzepte)",
            "subtitle": "1.2x / 1.4x Speed – Nur komplexe Mechanismen",
            "focus_type": "concept_stream",
            "icon": "🎧",
            "color": "#79c0ff",
            "badge": "Konzept-Stream (1.2x–1.4x)",
            "description": "Wissenschaftlich fundiert: Komplexe Erstthemen auf 1.2x, vertraute Schemata auf 1.4x. Reine Faktenlisten skippen (0x Skip = 100% Anki).",
            "is_break": False,
            "is_mandatory": False,
        },
        {
    ...
    if mandatory_events:
        ...
        blocks.append({
            ...
            "title": "Nachmittag: Praktika / Low-Executive Load",
            "subtitle": "Präsenzpflicht vor Ort oder entspanntes Skripten-Scanning",
            "focus_type": "afternoon_flex",
            "icon": "📖",
            "color": "#388bfd",
            "badge": "Low-Executive (180m)",
            "description": "Nachmittags-Tief abfangen: UZH-Praktika wahrnehmen oder am Schreibtisch nur entspannt Skripte überfliegen / Histo-Bilder sichten. Kein erzwungenes schweres Neulernen!",
            "is_break": False,
            "is_mandatory": False,
        })
